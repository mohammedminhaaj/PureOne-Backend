    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_number', models.CharField(db_index=True, error_messages={'unique': 'User already exists. Please use a different mobile number'}, max_length=10, unique=True, validators=[django.core.validators.RegexValidator('^[0-9]*$', 'Invalid mobile number')])),
                ('email', models.EmailField(blank=True, db_index=True, default=None, max_length=254, null=True, verbose_name='email address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mobile', models.CharField(db_index=True, max_length=10, unique=True, verbose_name='Mobile Number')),
